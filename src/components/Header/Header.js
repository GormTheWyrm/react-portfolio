            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="https://www.linkedin.com/in/geordinsoucie/" target="_blank">LinkedIn</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="https://github.com/GormTheWyrm" target="_blank">GitHub</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="https://gormthewyrm.github.io/" target="_blank">GitHub Pages Portal</a>
                    </li>
